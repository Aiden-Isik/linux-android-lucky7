...
#ifndef __S6E36W5X01_SMALL_PANEL_DIMMING_H___
#define __S6E36W5X01_SMALL_PANEL_DIMMING_H___
#include "../dimming.h"
 ...
 * PANEL : SDC
 */
static unsigned int s6e36w5x01_small_brt_tbl[S6E36W5X01_TOTAL_STEP] = {
...
static unsigned int s6e36w5x01_small_lum_tbl[S6E36W5X01_TOTAL_STEP] = {
	/* normal 10x25+6 */
...
static unsigned int s6e36w5x01_small_step_cnt_tbl[S6E36W5X01_TOTAL_STEP] = {
	[0 ... S6E36W5X01_TOTAL_STEP - 1] = 1,
};

static struct brightness_table s6e36w5x01_small_panel_brightness_table = {
	.control_type = BRIGHTNESS_CONTROL_TYPE_GAMMA_MODE2,
	.brt = s6e36w5x01_small_brt_tbl,
	.sz_brt = ARRAY_SIZE(s6e36w5x01_small_brt_tbl),
	.sz_ui_brt = S6E36W5X01_NR_STEP,
	.sz_hbm_brt = S6E36W5X01_HBM_STEP,
	.lum = s6e36w5x01_small_lum_tbl,
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = s6e36w5x01_small_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(s6e36w5x01_small_step_cnt_tbl),
	.vtotal = 3232,
};

static struct panel_dimming_info s6e36w5x01_small_panel_dimming_info = {
	.name = "s6e36w5x01_watch_fe",
	.dim_init_info = {
		NULL,
	},
	.target_luminance = -1,
	...
	.brt_tbl = &s6e36w5x01_small_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,
	.hbm_aor = NULL,
